...
const { md5, RC4, bytesToHex } = require('./crypto-rc4.js');
...
const { encodePasswordLegacy, encodePasswordAES256, PasswordEncodingError } = require('./password-encoding.js');
...
module.exports = { encryptPDF, AlreadyEncryptedError, PasswordEncodingError };
